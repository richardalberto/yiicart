...
<div class="row-fluid">
    <div class="span9"><h1><i class="icon-sitemap"></i>&nbsp;<?php echo Yii::t('language', 'Language'); ?></h1></div>
    <div class="span2">
        <div class="btn-group">
...
<table class="table table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th><?php echo Yii::t('language', 'Language Name'); ?></th>
            <th style="width: 150px;"><?php echo Yii::t('language', 'Code'); ?></th>
            <th style="width: 150px;"><?php echo Yii::t('language', 'Sort Order'); ?></th>
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo CHtml::checkBox('selected[]', false, array('value'=>$language->language_id)); ?></td>
            <td><?php echo $language->name; ?></td>
            <td><?php echo $language->code; ?></td>
            <td><?php echo $language->sort_order ?></td>
            <td><a class="btn btn-success btn-mini" href="<?php echo $this->createUrl('update', array('id'=>$language->language_id)); ?>"><?php echo Yii::t('common', 'Edit'); ?></button></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
</table>
