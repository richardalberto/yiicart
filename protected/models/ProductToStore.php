 ...
 *
 * The followings are the available columns in table 'product_to_store':
 * @property integer $product_id
 * @property integer $store_id
 */
class ProductToStore extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ProductToStore the static model class
	 */
