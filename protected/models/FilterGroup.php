 ...
 *
 * The followings are the available columns in table 'filter_group':
...
class FilterGroup extends CActiveRecord
{
	 ...
	 * @return FilterGroup the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('filter_group_id, sort_order', 'safe', 'on'=>'search'),
		);
	}
